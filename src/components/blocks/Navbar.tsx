...
export default function Navbar() {
  ...
  return (
    <header className="glass-nav sticky top-0 z-50 w-full">
      ...
      <div
        className={cn(
          "fixed inset-0 z-[999] bg-black/40 backdrop-blur-sm transition-opacity duration-300 md:hidden",
      ...
      <div
        className={cn(
          "fixed inset-y-0 right-0 z-[1000] w-[min(88vw,20rem)] border-l border-border/60 bg-background p-6 shadow-[0_8px_40px_-8px_rgb(0_0_0_0.15)] transition-transform duration-300 ease-out md:hidden",
